...
const DashboardPage = () => {
  ...
  return (
    <div className="space-y-12 animate-fade-in pb-12">
      ...
      <div className="bg-gradient-to-r from-primary-dark via-primary to-secondary rounded-[2.5rem] p-8 md:p-16 text-white shadow-2xl relative overflow-hidden">
        ...
        <div className="max-w-2xl space-y-6 relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight leading-tight drop-shadow-sm">
            Find & Book Your{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-200 to-white block sm:inline">Next Arena</span>
          </h1>
