        ...
        <div className="flex-1 w-full">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-xl leading-5 bg-gray-50 placeholder-gray-400 focus:outline-none focus:bg-white focus:ring-2 focus:ring-primary focus:border-primary transition-all sm:text-sm"
              aria-label="City"
            />
          </div>
        </div>
