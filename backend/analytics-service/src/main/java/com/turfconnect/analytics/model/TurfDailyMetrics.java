...
@Document(collection = "turf_daily_metrics")
@CompoundIndex(name = "turf_date_idx", def = "{'turfId': 1, 'date': 1}", unique = true)
public class TurfDailyMetrics {
