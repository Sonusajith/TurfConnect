...
public interface InvitationService {
    ...
    InvitationResponse acceptInvitation(String invitationId, String userId, String email);
    InvitationResponse declineInvitation(String invitationId, String userId, String email);
    List<InvitationResponse> getPendingInvitations(String userId, String email);
}
